...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => 'Edit Member'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    <div class="card shadow mb-4">
        <div class="card-body">
            <form class="row" action="<?php echo e(route('admin.members.update', $member)); ?>" method="POST" onsubmit="return confirm('Anda yakin ingin mengedit member ini?')">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>

                <div class="col-12 mb-3">
                    <label for="name" class="form-label">Nama</label>
                    <input type="text" name="name" class="form-control" id="name" value="<?php echo e(old('name', $member->name)); ?>">
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    <select name="number_type" id="number_type" class="form-control">
                        <?php $__currentLoopData = \App\Models\User::NUMBER_TYPES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $numberType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php if(old('number_type', $member->number_type) === $numberType): echo 'selected'; endif; ?> value="<?php echo e($numberType); ?>"><?php echo e($numberType); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    <input type="number" name="number" class="form-control" id="number"
                        value="<?php echo e(old('number', $member->number)); ?>">
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="telephone" id="telephone" class="form-control"
                            aria-label="Telephone" aria-describedby="telephoneLabel" value="<?php echo e(old('telephone', $member->telephone)); ?>">
                    </div>
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    <?php $__currentLoopData = \App\Models\User::GENDERS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gender): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="form-check form-check-inline">
                            <input <?php if(old('gender', $member->gender) === $gender): echo 'checked'; endif; ?> class="form-check-input" type="radio" name="gender"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-flex w-100 mt-3 justify-content-end">
                    <a href="<?php echo e(route('admin.members.index')); ?>" class="btn btn-warning mx-3">Kembali</a>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\perpustakaan-sekolah\resources\views/admin/members/edit.blade.php ENDPATH**/ ?>