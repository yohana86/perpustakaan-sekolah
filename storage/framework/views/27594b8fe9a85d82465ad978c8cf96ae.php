...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => 'Tambah Member'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    <div class="card shadow mb-4">
        <div class="card-body">
            <form class="row" action="<?php echo e(route('admin.members.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\perpustakaan-sekolah\resources\views/admin/members/create.blade.php ENDPATH**/ ?>