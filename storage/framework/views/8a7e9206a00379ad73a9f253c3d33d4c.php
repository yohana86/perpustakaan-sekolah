...
<?php $component->withAttributes([]); ?>
    <section class="d-flex flex-column justify-content-center align-items-center text-center mt-5 py-5 px-3">
        ...
        <form action="<?php echo e(route('search')); ?>" method="GET" class="d-flex w-100 my-4 justify-content-between align-items-center" style="max-width: 900px;">
                ...
                <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('preview', $book)); ?>" class="col text-dark text-decoration-none">
                        <div class="card h-100 shadow-sm">
                            <img src="<?php echo e(isset($book->cover) ? asset('storage/' . $book->cover) : asset('storage/placeholder.png')); ?>" alt="<?php echo e($book->title); ?>" class="card-img-top" style="object-fit: cover; height: 200px;">
                            <div class="card-body text-center">
                                <h3 class="card-text fs-6 fw-bold mb-3"><?php echo e($book->title); ?></h3>
                                <span class="fs-6">
                                    <?php if(request('sort_by') == 'popular'): ?>
                                        Dipinjam <span class="fw-bold text-decoration-underline"><?php echo e($book->borrows_count); ?></span> kali
                                    <?php else: ?>
                                        Terbit <span class="fw-bold text-decoration-underline"><?php echo e($book->created_at->locale('id_ID')->diffForHumans()); ?></span>
                                    <?php endif; ?>
                                </span>
                            </div>
                        </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\perpustakaan-sekolah\resources\views/home.blade.php ENDPATH**/ ?>