...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => 'Tambah Buku'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    <div class="card shadow mb-4">
        <div class="card-body">
            <form class="row" action="<?php echo e(route('admin.books.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-12 mb-3">
                    ...
                    <textarea name="synopsis" class="form-control" id="synopsis"><?php echo e(old('synopsis')); ?></textarea>
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    <select name="status" id="status" class="form-control">
                        <?php $__currentLoopData = \App\Models\Book::STATUSES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php if(old('status') === $status): echo 'selected'; endif; ?> value="<?php echo e($status); ?>"><?php echo e($status); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\perpustakaan-sekolah\resources\views/admin/books/create.blade.php ENDPATH**/ ?>